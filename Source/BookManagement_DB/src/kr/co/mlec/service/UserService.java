...
public class UserService {
	 ...
	 * 도서 대여
	 */
	public int insertBook(int bookNo, UserVO user) throws Exception {
		return dao.insert(bookNo, user);
	}
	
	/*
	 * 도서 반납
	 */
	public int deleteBook(int bookNo, UserVO user) throws Exception {
		return dao.delete(bookNo, user);
	}
